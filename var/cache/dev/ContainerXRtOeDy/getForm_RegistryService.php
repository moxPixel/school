...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\AdminEditUserType' => ['privates', 'App\\Form\\AdminEditUserType', 'getAdminEditUserTypeService', true],
            ...
            'App\\Form\\EditCalendarType' => ['privates', 'App\\Form\\EditCalendarType', 'getEditCalendarTypeService', true],
            'App\\Form\\EditLanguageCategoryType' => ['privates', 'App\\Form\\EditLanguageCategoryType', 'getEditLanguageCategoryTypeService', true],
            'App\\Form\\EditSessionType' => ['privates', 'App\\Form\\EditSessionType', 'getEditSessionTypeService', true],
            'App\\Form\\EditUserType' => ['privates', 'App\\Form\\EditUserType', 'getEditUserTypeService', true],
            'App\\Form\\IsReadType' => ['privates', 'App\\Form\\IsReadType', 'getIsReadTypeService', true],
            'App\\Form\\LanguageCategoryType' => ['privates', 'App\\Form\\LanguageCategoryType', 'getLanguageCategoryTypeService', true],
            'App\\Form\\MessengerType' => ['privates', 'App\\Form\\MessengerType', 'getMessengerTypeService', true],
            ...
            'App\\Form\\AdminEditUserType' => '?',
            'App\\Form\\CalendarType' => '?',
            'App\\Form\\CourseType' => '?',
            'App\\Form\\EditCalendarType' => '?',
            'App\\Form\\EditLanguageCategoryType' => '?',
            'App\\Form\\EditSessionType' => '?',
            'App\\Form\\EditUserType' => '?',
            'App\\Form\\IsReadType' => '?',
            'App\\Form\\LanguageCategoryType' => '?',
            'App\\Form\\MessengerType' => '?',
            'App\\Form\\NoteType' => '?',
