...
/* school/course/admin/view-technologies.html.twig */
class __TwigTemplate_45d2cdd95edccc11c91152d7b48c729fa2355fc031c1187cc4d837ac706dc823 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "school/course/admin/view-technologies.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "school/course/admin/view-technologies.html.twig"));

        $this->parent = $this->loadTemplate("layout.html.twig", "school/course/admin/view-technologies.html.twig", 1);
...
\t\t\t\t";
        // line 29
        $this->loadTemplate("components/_main-header.html.twig", "school/course/admin/view-technologies.html.twig", 29)->display($context);
        // line 30
        echo "\t\t\t\t<!--end::Header-->
\t\t\t\t<!--begin::Main-->
...
\t\t\t\t\t\t\t\t\tclass=\"text-dark fw-bolder my-1\">Technologies</a>
\t\t\t\t\t\t\t\t<!--end::Title-->
\t\t\t\t\t\t\t\t<!--begin::Breadcrumb-->
...
\t\t\t\t\t\t\t\t<a href=\"";
        ...
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("view-technologies");
        echo "\"
\t\t\t\t\t\t\t\t\tclass=\"btn btn-active-accent active fw-bolder ms-3\">Technologies</a>
\t\t\t\t\t\t\t\t<a href=\"";
        // line 63
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"fw-bolder fs-1 text-white\">technologies</span></span>
\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t<!--end::Text-->
\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t<!--end::Section-->
...
\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"background-image:url('/assets/media/illustrations/programming.png')\">
\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t<!--end::Pic-->
\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\tdata-bs-target=\"#kt_modal_add_techno\">Ajouter une technologies
\t\t\t\t\t\t\t\t\t</a>
...
\t\t\t\t\t\t\t\t\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["technologies"]) || array_key_exists("technologies", $context) ? $context["technologies"] : (function () { throw new RuntimeError('Variable "technologies" does not exist.', 114, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["techno"]) {
            // line 115
            echo "\t\t\t\t\t\t\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t\t\t\t\t\t\t<td>";
            // line 116
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["techno"], "name", [], "any", false, false, false, 116), "html", null, true);
            echo "</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\thref=\"";
            // line 121
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("technologies_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["techno"], "id", [], "any", false, false, false, 121)]), "html", null, true);
            echo "\"><i
...
\t\t\t\t";
        // line 176
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 176, $this->source); })()), "user", [], "any", false, false, false, 176), "role", [], "any", false, false, false, 176), "Administrateur"))) {
            // line 177
            echo "\t\t\t\t";
            ...
            echo "
\t\t\t\t";
        } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 178
(isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 178, $this->source); })()), "user", [], "any", false, false, false, 178), "role", [], "any", false, false, false, 178), "Formateur"))) {
            // line 179
            echo "\t\t\t\t";
            ...
            echo "
\t\t\t\t";
        } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 180
(isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 180, $this->source); })()), "user", [], "any", false, false, false, 180), "role", [], "any", false, false, false, 180), "Eleve"))) {
            // line 181
            echo "\t\t\t\t";
...
\t\t";
        // line 188
        $this->loadTemplate("messenger/index.html.twig", "school/course/admin/view-technologies.html.twig", 188)->display($context);
        // line 189
...
\t";
    ...
    {
        return "school/course/admin/view-technologies.html.twig";
    }
    ...
    {
        return array (  367 => 189,  365 => 188,  358 => 183,  352 => 181,  350 => 180,  345 => 179,  343 => 178,  338 => 177,  336 => 176,  286 => 128,  273 => 121,  265 => 116,  262 => 115,  258 => 114,  204 => 63,  199 => 61,  194 => 59,  189 => 57,  184 => 55,  171 => 45,  162 => 39,  151 => 30,  149 => 29,  134 => 16,  124 => 15,  113 => 12,  103 => 11,  92 => 8,  82 => 7,  71 => 4,  61 => 3,  38 => 1,);
    }
...
\t\t\t\t\t\t\t<div class=\"d-flex flex-column align-items-start justify-content-center flex-wrap me-1\">
\t\t\t\t\t\t\t\t<!--begin::Title-->
\t\t\t\t\t\t\t\t<a href=\"{{ path('view-technologies') }}\" class=\"\" onclick=\"addi()\"
\t\t\t\t\t\t\t\t\tclass=\"text-dark fw-bolder my-1\">Technologies</a>
\t\t\t\t\t\t\t\t<!--end::Title-->
\t\t\t\t\t\t\t\t<!--begin::Breadcrumb-->
\t\t\t\t\t\t\t\t<ul class=\"breadcrumb breadcrumb-line bg-transparent text-muted fw-bold p-0 my-1 fs-7\">
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"d-flex justify-content-between text-white pills badge badge-pill \">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\thref=\"{{ path('technologies_edit', { 'id':techno.id }) }}\"><i
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"fa fa-edit\"></i></a>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
...
\t{% endblock %}", "school/course/admin/view-technologies.html.twig", "C:\\wamp64\\www\\Unlock-Formation\\templates\\school\\course\\admin\\view-technologies.html.twig");
    }
}
