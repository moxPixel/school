...
class __TwigTemplate_01c4afccc530a0fc846049a16d2d04c8c30a40596db2c2ca0e0baecc41657a73 extends Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"modal-content\">
            <div class=\"container px-10 py-10\">
                ...
                <div class=\"modal-body\">
                    ...
                    ";
        // line 27
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Extension\HttpKernelRuntime')->renderFragment(Symfony\Bridge\Twig\Extension\HttpKernelExtension::controller("App\\Controller\\MessengerController::sendMessage", ["request" => twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 27)]));
        echo "
                    <!--end::Stepper-->
                </div>
            </div>
...
<div id=\"kt_drawer_chat\" class=\"bg-white\" data-kt-drawer=\"true\" data-kt-drawer-name=\"chat\"
    ...
    <div class=\"card w-100\" id=\"kt_drawer_chat_messenger\">
        ...
        // line 49
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 49), "fullname", [], "any", false, false, false, 49), "html", null, true);
        echo "</a>
                    <!--begin::Info-->
                    <div class=\"mb-0 lh-1\">
        ...
        // line 86
        echo twig_escape_filter($this->env, twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 86), "sent", [], "any", false, false, false, 86)), "html", null, true);
        echo "</span></a>
                        </div>
                        <!--end::Menu item-->
                    </div>
                ...
                <div class=\" mt-2 card custom-card\">
                    <div class=\"fullmessages card-body messagescontent\">
                        <div class=\"card-header pb-0 border-bottom-0\">
                            ...
                            ";
        // line 122
        if ((0 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 122), "received", [], "any", false, false, false, 122)), 0))) {
            // line 123
        ...
        $context['_seq'] = twig_ensure_traversable(twig_reverse_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 128), "received", [], "any", false, false, false, 128)));
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            ...
            echo "</span>
                                        ...
                                        <div class=\"menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold w-200px\" data-kt-menu=\"true\" style=\"\">
                                            ...
                                            <div class=\"menu-item px-3\">
                                                <a href=\"";
            // line 174
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("messenger_clear", ["id" => twig_get_attribute($this->env, $this->source, $context["message"], "id", [], "any", false, false, false, 174)]), "html", null, true);
            echo "\" class=\"menu-link px-3\">Supprimer ce message</a>
                                            </div>
                                            <div class=\"menu-item px-3\">
                                                <a href=\"#\"  data-bs-target=\"#kt_modal_message\" data-bs-toggle=\"modal\"  class=\"menu-link px-3\">Répondre à ce message</a>
                                            </div>
                                        </div>
                                        <!--end::Menu-->
                                        <!--end::Dropdown-->
            ...
            // line 187
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["message"], "message", [], "any", false, false, false, 187), "html", null, true);
            echo "</p>
                                        <!--end::Text-->
                                        <!--begin::Action-->
                                        ";
            // line 190
            if (twig_get_attribute($this->env, $this->source, $context["message"], "file", [], "any", false, false, false, 190)) {
                // line 191
                echo "                                        <a target=\"blank\" href=\"";
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/joint/" . twig_get_attribute($this->env, $this->source, $context["message"], "file", [], "any", false, false, false, 191))), "html", null, true);
            ...
            echo "                                        <div class=\"d-flex align-items-center\">
                                            ...
                                            <!--end::Svg Icon-->";
            // line 205
            echo twig_escape_filter($this->env, twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["message"], "recipient", [], "any", false, false, false, 205)), "html", null, true);
            echo "</a>
...
<!--end::Drawers-->";
    ...
    {
        return array (  315 => 224,  290 => 205,  278 => 195,  270 => 191,  268 => 190,  262 => 187,  246 => 174,  218 => 149,  212 => 148,  206 => 144,  200 => 140,  194 => 136,  192 => 135,  184 => 129,  180 => 128,  175 => 125,  171 => 123,  169 => 122,  130 => 86,  90 => 49,  65 => 27,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "messenger/index.html.twig", "/homepages/16/d846999941/htdocs/Unlock-Formation/templates/messenger/index.html.twig");
    }
}
