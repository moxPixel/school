...
class __TwigTemplate_9d0be6a959413dc468835b2a48ea0bfbdad79962eabbb094f7ac8f22c3af73f7 extends Template
{
    private $source;
    private $macros = [];
                    ...
                    <div
                        ...
                        <div class=\"symbol symbol-45px mx-5 py-5\">
                            <span class=\"symbol-label bg-primary align-items-end\">
                              ";
        // line 59
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 59), "sexe", [], "any", false, false, false, 59), 0))) {
            // line 60
...
($context["app"] ?? null), "user", [], "any", false, false, false, 62), "sexe", [], "any", false, false, false, 62), 1))) {
            // line 63
            echo "                                <img alt=\"Logo\" src=\"";
        ...
        echo "                            </span>
                        ...
                        <div class=\"\">
                            <span class=\"text-white fw-bolder fs-4\">
                                ";
        // line 70
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 70), "fullname", [], "any", false, false, false, 70), "html", null, true);
        echo "
                            </span>
                            <span class=\"text-white fw-bold fs-7 d-block\">
                                ";
        // line 73
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 73), "role", [], "any", false, false, false, 73), "html", null, true);
        echo "
                            </span>
                        </div>
                    </div>
        ...
        echo "\"
                ...
                <span class=\"text-end\">
                    ";
        // line 171
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 171), "checking", [], "any", false, false, false, 171), 1))) {
            // line 172
        ...
        // line 176
        echo "                    ";
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 176), "checking", [], "any", false, false, false, 176), 0))) {
            // line 177
        ...
        echo "                </span>
            ...
            <div class=\"ms-1 ms-lg-6\">
                ...
                ";
        // line 187
        if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 187), "notifications", [], "any", false, false, false, 187)), 0))) {
            // line 188
            echo "                <button class=\"btn btn-icon btn-sm btn-light-danger fw-bolder pulse pulse-danger\"
                    ...
                    <span class=\"position-absolute fs-6\">
                        ";
            // line 191
            echo twig_escape_filter($this->env, twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 191), "notifications", [], "any", false, false, false, 191)), "html", null, true);
            echo "
                    </span>
        ...
        // line 196
        echo "                ";
        if ((0 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 196), "notifications", [], "any", false, false, false, 196)), 0))) {
            // line 197
            echo "                <button class=\"btn btn-icon btn-sm btn-light-success fw-bolder pulse pulse-success\"
                    ...
                    <span class=\"position-absolute fs-6\">
                        ";
            // line 200
            echo twig_escape_filter($this->env, twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 200), "notifications", [], "any", false, false, false, 200)), "html", null, true);
            echo "
                    </span>
                    <span class=\"pulse-ring\"></span>
                </button>
                ...
                <div class=\"menu menu-sub menu-sub-dropdown menu-column menu-rounded fw-bold menu-title-gray-800 menu-hover-bg menu-state-title-primary w-250px w-md-300px\"
                    ...
                    <div class=\"menu-item mx-3\">
                        <div class=\"menu-content fs-6 text-dark fw-bolder py-6\">
                            ";
        // line 210
        echo twig_escape_filter($this->env, twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 210), "notifications", [], "any", false, false, false, 210)), "html", null, true);
        echo "
                            Notifications
                        </div>
                    </div>
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 217), "notifications", [], "any", false, false, false, 217));
            ...
            echo "
                            ...
                            <div class=\"col-md-1\">
                                <a
                                    href=\"";
            // line 242
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("notification_clear", ["id" => twig_get_attribute($this->env, $this->source, $context["notif"], "id", [], "any", false, false, false, 242), "redirect" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 242), "requestUri", [], "any", false, false, false, 242)]), "html", null, true);
            echo "\">
        ...
        echo "\" class=\"btn btn-primary fw-bolder me-2 px-5\">
                            ...
                            ";
        // line 256
        if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 256), "notifications", [], "any", false, false, false, 256)), 0))) {
            // line 257
            echo "                            <a href=\"";
    ...
    {
        return array (  386 => 261,  378 => 257,  376 => 256,  370 => 253,  363 => 248,  351 => 242,  340 => 234,  334 => 231,  324 => 224,  316 => 218,  312 => 217,  302 => 210,  295 => 205,  287 => 200,  282 => 197,  279 => 196,  271 => 191,  266 => 188,  264 => 187,  256 => 181,  250 => 177,  247 => 176,  241 => 172,  239 => 171,  204 => 139,  182 => 120,  157 => 98,  135 => 79,  126 => 73,  120 => 70,  114 => 66,  107 => 63,  105 => 62,  99 => 60,  97 => 59,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "components/_main-header.html.twig", "/homepages/16/d846999941/htdocs/Unlock-Formation/templates/components/_main-header.html.twig");
    }
}
